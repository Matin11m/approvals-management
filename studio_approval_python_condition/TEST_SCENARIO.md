...
2. راهنمای readonly در هر تب در دو بخش (قوانین + مثال‌ها) نمایش داده می‌شود.
...
3. بررسی کنید دو تب زیر وجود داشته باشد:
   - `Approver Python`
   - `Notify Python`
4. داخل هر تب دو guide readonly را بررسی کنید (rules و examples).

### انتظار
- هر دو تب دیده شوند.
- در هر تب دو guide readonly نمایش داده شود.
